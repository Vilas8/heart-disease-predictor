            ...
            <tr><td style="padding:28px 32px 16px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="font-size:13px;font-weight:700;color:#437a22;text-align:right;padding-bottom:6px;">{prob_safe}%</td>
                </tr>
                <tr><td colspan="2"><div style="background:#edeae5;border-radius:4px;height:8px;overflow:hidden;">
                  <div style="background:#6daa45;height:8px;width:{prob_safe}%;border-radius:4px;"></div></div></td></tr>
                <tr><td colspan="2" style="height:10px;"></td></tr>
                <tr>
                  <td style="font-size:13px;color:#28251d;padding-bottom:6px;">Heart Disease</td>
                  <td style="font-size:13px;font-weight:700;color:#a13544;text-align:right;padding-bottom:6px;">{prob_disease}%</td>
                </tr>
                <tr><td colspan="2"><div style="background:#edeae5;border-radius:4px;height:8px;overflow:hidden;">
                  <div style="background:#dd6974;height:8px;width:{prob_disease}%;border-radius:4px;"></div></div></td></tr>
              </table>
            </td></tr>
